...
| `vm dump <n> [file]` | Dump VM XML to file (default: `<n>.xml`) |
...
# Export current VM config to a file
...
- `vm dump` exports the full XML to a file for backup or debugging — defaults to `<vm-name>.xml` in the current directory
